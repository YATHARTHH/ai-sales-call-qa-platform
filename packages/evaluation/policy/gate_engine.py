"""Deterministic Policy Gate Engine enforcing the 10-condition precedence truth table."""
...
class DeterministicPolicyEngine:
    ...
    Adheres strictly to the 10-condition policy precedence truth table.
    """
    ...
    def evaluate_gate(
        ...
        # 10. Condition 10: All critical checks passed & passing score achieved
        return GateDecision.create(
            sale_id=sale_id,
            evaluation_run_id=evaluation_run_id,
